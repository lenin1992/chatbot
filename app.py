...
if not GOOGLE_CX_CODE:
    missing_keys.append("GOOGLE_CX_CODE")

if missing_keys:
    st.error(f"❌ Missing keys: {', '.join(missing_keys)}. Please check your .env file.")
    raise ValueError("❌ Required API keys are missing! Check your .env file.")
